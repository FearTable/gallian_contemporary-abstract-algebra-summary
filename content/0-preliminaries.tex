...
\begin{prf}
  ...
  Surely $bq+r=b \widetilde q+ \widetilde r$ and therefore $b(q-\widetilde q)=\widetilde r-r$. So $b$ devides $\widetilde r-r$.
  But since we had $r \leq \widetilde r$ we have that
  $0 \leq \widetilde r - r \leq \widetilde r < b$. This implies that $\widetilde r-r = 0$ which is the same as $\widetilde r=r$. This also implies that $\widetilde q=q$. [because $b \widetilde{q} + 0 = bq + 0.$]
...
\begin{mydef}[Greatest Common Divisor, Relatively Prime Integers]
  The \qt{greatest common divisor} of two nonzwero integers $a$ and $b$ is the largest of all common divisors of $a$ and $b$. We denote this integer by $\gcd (a,b)$.
...
\end{thm-non}
\begin{prf}
  Suppose $p$ is a prime \st $p \mid ab$ but w.l.o.g. $\neg (p \mid a)$.
  \begin{equation}
