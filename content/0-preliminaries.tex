...
\begin{prf}
  ...
  Since $p$ divides $abs$ and $ptb$, it follows that $p$ also devides $b$. [and does not divide $a$ according to our assumtion.] Since the roles of $a$ and $b$ are interchanchable, the theorem is proved.
\end{prf}
